...
**DadaLeaderboards 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Ologrammi top soldi, kill e playtime.

| Field | Value |
| --- | --- |
| Plugin | `DadaLeaderboards` |
| Version | `1.0` |
| Category | Community, Web and Display |
| Main class | `it.dadasmp.leaderboards.DadaLeaderboardsPlugin` |
| Dependencies | `softdepend: [Vault]` |
...
`release/DadaLeaderboards-1.0.jar`
